...
def cds():
    all_data_frame = []
    code = ['malaysia','mexico','netherlands','new-zealand','norway','pakistan','panama','peru','philippines','poland',\
    'portugal','qatar','russia','saudi-arabia','south-africa','south-korea','spain','sweden','switzerland',\
    ...
    for i in code:
        ...
        print(df)
        if date1 >= preday_search() and  CRD_ESTI_INST != 'DBRS':
